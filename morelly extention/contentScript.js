...
const findTargetDiv = (intervalId) => {
    ...
    targets.forEach(target => {
        ...
        if (!target.querySelector('.morelly-icon-button') || !target.querySelector('div.morelly')) {
            target.insertAdjacentHTML("beforeend", `
                <div id=":rj2" class="J-JN-M-I J-J5-Ji Xv L3 T-I-ax7 T-I morelly-icon-button" role="button" tabindex="1" aria-haspopup="true" aria-expanded="false" aria-label="More options" style="user-select: none; padding-left: 10px" data-v-app="">
...
const setupSignaturesPanelButtonListener = () => {
    ...
    if (signaturesPanelButtons.length > 0) {
        ...
        setTimeout(setupSignaturesPanelButtonListener, 100);
    }
};
...
// // Event listener for the Compose button
// const setupComposeButtonListener2 = () => {
//     const composeButton = document.querySelector('div.T-I.T-I-KE.L3[role="button"][jscontroller="eIu7Db"]');
//     if (composeButton) {
//         composeButton.addEventListener('click', setupSignaturesPanelButtonListener);

//     } else {
//         // Keep trying to add the listener until the Compose button is found
//         setTimeout(setupComposeButtonListener2, 100);
//     }
// };
